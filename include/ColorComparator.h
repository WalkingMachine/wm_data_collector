...
namespace ColorComparison{
    ...
    const float ColorProximityMatrix[]{
            ...
            /*              Red,    Orange, Yellow, Green,  cyan,   Blue,   magenta, Brown,  Grey,   White,  Black  */
            /* 0 Red    */  1,      0.8,    0.5,    0,      0,      0.2,    0.8,    0.6,    0.2,    0.2,    0.7,
            ...
            /* 4 cyan   */  0,      0,      0.5,    0.8,    1,      0.8,    0.5,    0.6,    0.5,    0.8,    0.7,
            /* 5 Blue   */  0.2,    0,      0,      0.5,    0.8,    1,      0.8,    0.6,    0.8,    0.8,    0.8,
            /* 6 magenta*/  0.8,    0.5,    0,      0,      0.6,    0.8,    1,      0.6,    0.5,    0.8,    0.8,
            /* 7 Brown  */  0.8,    0.8,    0.6,    0.6,    0,      0.6,    0.6,    1,      0.5,    0,      0.9,
            /* 8 Grey   */  0.6,    0.2,    0.5,    0.5,    0.5,    0.8,    0.5,    0.5,    1,      0.8,    0.8,
